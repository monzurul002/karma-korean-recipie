...
const Blogs = () => {
    ...
    return (
        <div className="container  py-5">
            <div className="d-flex py-3  mb-2 justify-content-end">

                <Button onClick={toPDF} className="btn btn-warning">Download pdf  <BsFillFilePdfFill /></Button>
            </div>
            <div className="shadow p-3" ref={targetRef}>
                <h3 className="text-primary py-2">Web Development Blogs</h3>
                <div>
